        ...
        <>
          ...
          >
            <div className="logo">
              ...
              <p className=" effect text-lg font-bold text-[#F8C078]">
                Pet Foods
              </p>
            </div>
            ...
            <div
              ...
              className="xl:hidden lg:hidden block cursor-pointer"
            >
          ...
          {/* mobile */}
          <div className="social_icons flex items-center xl:w-fit lg:w-fit w-full justify-center gap-5 xl:hidden lg:hidden py-5">
            {searchBar ? (
              ""
            ) : (
              <div
